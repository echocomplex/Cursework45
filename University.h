...
public:
    ...
    Triple <List <std::pair <Student, float>>, List <std::pair <Student, float>>, List <std::pair <Student, float>>> split (const std::string group, const unsigned short session, const std::string gender);
